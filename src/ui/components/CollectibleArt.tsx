...
// 配色取主题 candy 系字面值（styles.css :root 同源），风格与 PlanetIcon 一致：
// 大色块 + 点睛小高光，零素材。未知 id 兜底渲染 collection.ts 的 emoji。
...
const ART: Record<string, () => JSX.Element> = {
  stardust: () => (
    <>
      <path d={star(48, 50, 30)} fill="#ffc93c" stroke="#e8a20c" stroke-width="3" stroke-linejoin="round" />
  ...
  'rocket-fin': () => (
    <>
      ...
      <path d="M40 34 C20 44 14 62 16 76 L40 62 Z" fill="#ff6fa5" stroke="#d14c82" stroke-width="3" stroke-linejoin="round" />
      <path d="M58 34 C78 44 84 62 82 76 L58 62 Z" fill="#ff6fa5" stroke="#d14c82" stroke-width="3" stroke-linejoin="round" />
  ...
  'bubble-alien': () => (
    <>
      ...
      <ellipse cx="48" cy="54" rx="20" ry="17" fill="#4fc3f7" stroke="#2e96c9" stroke-width="3" />
      <circle cx="48" cy="30" r="4" fill="#4fc3f7" />
      <line x1="48" y1="34" x2="48" y2="40" stroke="#2e96c9" stroke-width="3" />
  ...
  porthole: () => (
    <>
      ...
      <path d={star(42, 46, 7)} fill="#ffc93c" />
  ...
  'three-eye': () => (
    <>
      <path d="M28 78 C14 66 16 34 48 30 C80 34 82 66 68 78 Z" fill="#3ddc97" stroke="#23aa71" stroke-width="3" stroke-linejoin="round" />
  ...
  'nebula-jelly': () => (
    <>
      <path d="M20 52 C20 30 76 30 76 52 Z" fill="#9b7ede" stroke="#7557bb" stroke-width="3" stroke-linejoin="round" />
      {[28, 40, 52, 64].map((x, i) => (
        <path key={x} d={`M${x} 54 q4 8 0 14 q-4 6 0 12`} fill="none" stroke={i % 2 ? '#c9b6f2' : '#9b7ede'} stroke-width="5" stroke-linecap="round" />
      ))}
  ...
  booster: () => (
    <>
      ...
      <rect x="34" y="24" width="28" height="7" fill="#ff9f55" />
  ...
  'ring-cat': () => (
    <>
      <path d="M30 38 L26 18 L42 30 Z" fill="#ff9f55" stroke="#e07a2e" stroke-width="3" stroke-linejoin="round" />
      <path d="M66 38 L70 18 L54 30 Z" fill="#ff9f55" stroke="#e07a2e" stroke-width="3" stroke-linejoin="round" />
      <circle cx="48" cy="52" r="26" fill="#ff9f55" stroke="#e07a2e" stroke-width="3" />
  ...
  'galaxy-dolphin': () => (
    <>
      <path d="M14 58 C22 34 56 24 78 36 C74 40 70 42 66 43 C78 50 76 64 64 70 C60 62 54 58 48 58 C40 70 26 70 14 58 Z"
        fill="#4fc3f7" stroke="#2e96c9" stroke-width="3" stroke-linejoin="round" />
      <path d="M46 34 C48 24 58 22 60 28 C54 30 50 32 46 34 Z" fill="#4fc3f7" stroke="#2e96c9" stroke-width="3" stroke-linejoin="round" />
      <path d="M20 56 C30 50 42 48 52 50" fill="none" stroke="#bfe9ff" stroke-width="4" stroke-linecap="round" />
      <Eye cx={68} cy={42} r={3.8} />
      <path d={star(24, 26, 5)} fill="#ffc93c" />
      <path d={star(84, 56, 4)} fill="#ffc93c" />
    </>
  ),
  'golden-saucer': () => (
    <>
      ...
      <Eye cx={48} cy={33} r={4} />
      <ellipse cx="48" cy="46" rx="38" ry="13" fill="#ffc93c" stroke="#e8a20c" stroke-width="3" />
      {[24, 40, 56, 72].map((x) => (
